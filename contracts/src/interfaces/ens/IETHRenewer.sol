...
// Vendored verbatim from the verified source of the ENSv2 hackathon ETHRegistrar
// (Sepolia 0x7d1b7f586a62ac3f54b9a396849757814283270b, ensdomains/namechain
// contracts/src/registrar/interfaces/IETHRenewer.sol, 2026-09-10). The older beta registrar
// exposes renew(string,uint64,address,bytes32) instead; the vault targets this one (spec §2).
